...
export MODEL_NAME = dsnet_shtechBv11_da_ri.onnx
...
models/dsnet:
	...
	wget https://storage.gra.cloud.ovh.net/v1/AUTH_df731a99a3264215b973b3dee70a57af/share/$(MODEL_NAME) -P models/dsnet
